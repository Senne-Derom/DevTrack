...
public class UserServiceTest {
    ...
    void givenRegisterUser_whenValidInput_thenReturnSavedUser() {
        RegisterUserInput registerUserInput = new RegisterUserInput("testuser", "test.user@mail.com", "rawPassword123");
        ...
        UserOutput actualSavedUser = userService.registerUser(registerUserInput);
        assertNotNull(actualSavedUser);
        assertEquals("testuser", actualSavedUser.username());
        assertEquals("test.user@mail.com", actualSavedUser.email());
